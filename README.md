...
# 19.11.20
Булат Зураев, Соков Илья
**Цель реализовать все методы. Пока что без пулов**
Цели выполнены. И протестированы.

# 26.11.20
Соков Илья, Александр Мариинский
**Цель создать представление для 4го метода.**
Мы долго мучались и смогли написать ВООООООТ ТАКОЕ ВОТ представление.
Это определенно заслуживает пятерки. 

# 03.12.20
Александр Мариинский, Шевчук Алиса
**Дописать 4 метод**
Цели выполнена, пять!