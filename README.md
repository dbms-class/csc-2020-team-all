...
## Практика 19.11.2020
Выполняли: Алена Кребс, Тихон Воробьев

Цель: Создать бд и добавить фиктивные данные на сайте elephantsql.com. Реализовать три запроса из тз.

Результаты: Подключились к удаленной бд. Реализовали три запроса. Проверили их на корректность. Поправили html для красоты.

Самооценка: 5

## Практика 26.11.2020
Выполняли: Алексей Русанов, Тихон Воробьев

Цель: проверить текущий код, реализовать методы при помощи peewe.

Результаты:

Создали удобный код для создания таблиц.

Немного изменили интерфейс в connect и webapp.

Стали использовать контекстный менеджер, то есть теперь не надо все время писать конструкцию try - finally.

Переписали все методы через peewe.
