...
**03.12.20 [Зураев, Воробьев] Цель**: попробовать переписать реализованные методы при помощи ORM
**Результат**: переписали некоторые таблички в виде классов, переписали некоторые запросы через ORM, мы молодцы.

**03.12.20 [Лопатин, Воробьев] Цель**: попробовать переписать методы на pewee
**Результат**: переписали основные методы, мы молодцы.
**26.11.20 [Гащенко, Лопатин] Цель**: реализовать метод status_retail
