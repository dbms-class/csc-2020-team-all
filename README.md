## Журнал:
10.12 Кребс, Русанов
*Цель*: Доделать /volunteer_load
*Результат*: цель выполнена + начали /volunteer_unassign


03.12 Олешкевич, Кребс
*Цель*: Проверить первые три метода на работоспособность и исправить
*Результат*: Проверили и исправили первые три метода, начали /volunteer_load
