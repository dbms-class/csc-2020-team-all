## 2020-12-10
**Сеньор**:  Екатерина Гащенко 
**Джуниор**: Алексей Лопатин  
**Цель**: доделать shift_timetable
**Результат**: цель достигнута

## 2020-12-03
**Сеньор**:  Максим Щербаков 
**Джуниор**: Екатерина Гащенко  
**Цель**: доработать старые хендлеры, написать новый  
**Результат**: цель выполнена на 70%, осталось доделать обработку конфликтов


## 2020-11-26
**Сеньор**:  Артем Грачев 
**Джуниор**: Максим Щербаков  
**Цель**: использовать представления, исправить ошибки  
**Результат**: цель достигнута
...
* настроили хендлеры: `/stops`, `/routes`, `update_timetable` 
* добавили хендлеры: `/get_timetable`
