...
Сеньор: Арина Уланова

Джун: Эльман Абдурахманов

Цель: расчитываем создать сервер и реализовать метод `bands`

Результат: все сделали 

#### 26.11.2020

Сеньор: Эльман Абдурахманов

Джун: Даниил Орешников

Цель: 
1. сделать все запросы (до 4-го включительно): `albums`, `update_album`, `get_distributions`
2. (опционально, но маловероятно) реализовать сложные запросы с 
использованием builder/ORM/...

Результат: сделали все запросы (на чистом SQL)

#### 26.11.2020

Сеньор: Даниил Орешников

Джун: Дубровин Алексей

Цель: 
1. реализовать ORM с использованием peewee
2. (опционально) реализовать запрос `musician_unassign`

Результат: реализовали ORM и первую часть запроса `musician_unassign`
