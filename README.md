В файле inserts.sql небольшой код для заполнения бд, если захотите потестировать у себя.

10/12/20 Волкова, Уланова
Цель: Сделать view для 5дз
Итог: Закончили view. Проверили на данных, что вроде работает :)
