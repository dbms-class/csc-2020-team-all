...
19.11
Дубровин, Селиванов
Цель — продолжить делать register
Результат - Успели сделать только набросок register

26.11
Дубровин, Уланова
Цель — доделать register
Результат — сделали register и вьюху для 4 запроса

03.12
Уланова, Соков
Цель — исправить вьюху для 4 запроса и написать /volunteer_load
Результат — все исправили, все сделали, все протестировали :) // для 4-го метода. Ставим себе 5 баллов.

10.12
Соков, Марьинский
Цель -  попытаемся заменить sql-запросы на ORM.
Результат - заменили ручки /register, /countries, /volunteers на ORM
Большая работа и много неожиданностей подстерегало нас на пути. Ставим 5!
