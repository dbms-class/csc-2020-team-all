## Журнал:
3.12.20 Олешкевич, Кребс
*Цель*: Проверить первые три метода на работоспособность и исправить, в случае ошибок. Заполнить таблицу Task and Volonteers, разобраться с view /volunteer_load, разобраться с peewee


Цель: Проверить первые три метода на работоспособность и исправить
Результат: Проверили и исправили первые три метода, начали /volunteer_load, поразбирались со всем, что могли, запонлили таблицы


26.11 Шевчук, Олешкевич
*Цель*: view /volunteer_load
*Результат* 3.5 Написали метод, но пока не проверяли на работоспособность

19.11, Тихонков, Шевчук.  
*Цель*: Доделать register. Добавить оптимизации: переписать register, volunteers, countries с использованием ConnectionFactory.

*Результат* 5. Сделали то, что хотели
