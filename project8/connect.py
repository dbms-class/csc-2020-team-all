...
def parse_cmd_line():
    ...
    parser.add_argument('--pg-user', help='PostgreSQL user', default='axmhakbj')
    parser.add_argument('--pg-password', help='PostgreSQL password', default='HYKKkDDGEPtKBwz-puOw-jCJCtMi6rNs')
    parser.add_argument('--pg-database', help='PostgreSQL database', default='axmhakbj')
