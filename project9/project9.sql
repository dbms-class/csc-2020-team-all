...
-- связь M:1
-- у каждой страны несколько регионов, каждый регион пренадлежит одной стране
CREATE TABLE Region
(
    id         SERIAL,
    name       TEXT NOT NULL,
...
-- каждая группа пренадлежит одному региону
-- каждый регион может содержать несколько групп
CREATE TABLE Groups
(
    id        SERIAL,
    name      TEXT NOT NULL UNIQUE,
...
-- информация об участии музыканта в группе:
...
-- у каждой группы может быть несколько альбомов, каждый альбом пренадлежит одной группе
-- связь с жанрами N:1
-- один жанр может быть у нескольких альбомов, каждому альбому пренадлежит один жанр
CREATE TABLE Album
(
    id       SERIAL,
...
-- ссылка на альбом
-- связь с альбомом N:1
-- каждому альбому может пренадлежать несколько треков
-- один трек пренадлежит одному альбому
CREATE TABLE Track
(
